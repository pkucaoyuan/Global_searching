...
\begin{table}[t]
\centering
\caption{Flow-based model results. Even with originally deterministic sampling,
our global scheduling improves quality by strategically allocating search compute.}
...
improvements even when applied to flow-based models with injected stochasticity.
...
% TODO: Add specific analysis once experimental results are available.
