...
budgets per prompt.
\cref{sec:sde-foundations} derives the theoretical structure that underlies
both stages, and \cref{sec:scheduling-optimality} establishes optimality
properties of the resulting allocation.
...
We derive this structure from first principles by connecting
noise search to the underlying diffusion SDE.
...
\cref{thm:loc-scale} enables a sharp characterization of the optimal
budget allocation.
